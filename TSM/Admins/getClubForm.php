...
echo "<div class='container'>";
   ...
   echo "<div class='container'>";
        ...
        while($row = mysqli_fetch_array($result)){
                $cform_id = $row['cform_id'];
                $cform_Name = $row['cform_Name'];
                $cform_des = $row['cform_des'];
                $cform_email = $row['cform_email'];
                $isApproved = $row['isApproved'];
            echo "<tr>";
                echo "<td>" . $row['cform_id'] . "</td>";
                echo "<td>" . $row['cform_Name'] . "</td>";
                echo "<td>" . $row['cform_des'] . "</td>";
                echo "<td>" . $row['cform_email'] . "</td>";
                echo "<td>"."<a href='upClub.php?approve=$cform_id'>Approve</a>"."</td>";
                echo "<td>"."<a href='upClub.php?reject=$cform_id'>Reject</a>"."</td>";
            echo "</tr>";
        }
           echo "</table>";
        echo "</div>";
