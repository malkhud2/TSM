...
// "<div class='banner-img'><img src='Images/tutorForm.png' alt=''>\n".
    "<div class='well'>\n".
    "<img src='Images/tutorForm.png' alt='Nature' class='responsive'>\n".
        "<div class='container'>\n".
    "<h2>Become a Tutor</h2>\n".
 "<form method='post' action='tutorForm.php' >\n".
      	
      "<div class='well'>\n".
    "<div class='form-group'>\n".
      "<label for='tform_GPA'>What is your GPA? </label>\n".
      "<input type='text' class='form-control'  name='tform_GBA' style='height:50px'>\n".
      "</div>\n".
      
    //   "<div class='form-group'>\n".
    //   "<label for='tform_skill'> Why do you want to become a Tutor?</label>\n".
    //   "<input type='text' class='form-control' name='tform_skill' style='height:200px'>\n".
    //   "</div>\n".
       "<div class='form-group'>\n".
      "<label for='tform_skill'>Why do you want to become a Tutor?</label>\n".
      " <textarea class='form-control 'name='tform_skill'  cols='30' rows='10'>\n".
    ...
    "<div class='container'>\n".
    "<button type='submit' class='btn btn-default' name='btn-tutor-form'>Submit</button>\n".
    "</div>\n".
