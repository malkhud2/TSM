...
print    
 ...
 "<form method='post' action='tutor_new_post.php' >\n".
      ...
      "<label for='tutor_date'>Date:</label>\n".
      "<input type='date' class='form-control'   name='tutor_date' style='height:50px'>\n".
      "</div>\n".


    "<div class='form-group'>\n".
      "<label for='tutor_time'>Time:</label>\n".
      "<input type='time' class='form-control'   name='tutor_time' style='height:50px'>\n".
      "</div>\n".
                
    "<div class='form-group'>\n".
      "<label for='fileToUpload'>Class:</label>\n".
      "<input type='text' class='form-control'   name='tutor_class' style='height:50px'>\n".
      "</div>\n".
      
       "<div class='form-group'>\n".
      "<label for='fileToUpload'>Location:</label>\n".
      "<input type='text' class='form-control'  name='tutor_loucation' style='height:50px'>\n".
      "</div>\n".
                
    // "<div class='form-group'>\n".
    //   "<label for='fileToUpload'>price:</label>\n".
    //   "<input type='text' class='form-control'   name='tutor_price' style='height:50px'>\n".
    //   "</div>\n".
                "</div>\n".
