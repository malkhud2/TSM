...
//  "<form method='post' action='book_new_post.php' >\n".
 ...
 "<form method='post' action='book_new_post.php' >\n".
  ...
  "<div class='form-group'>\n".
      ...
      "<div class='form-group'>\n".
         "<label for='book_info'>Extra Info</label>\n".
       " <textarea class='form-control 'name='book_info' cols='30' rows='10'>\n".
        " </textarea>\n".
     " </div>\n".
     ...
     "<div class='container'>\n".
    "<button type='submit' class='btn btn-primary' name='new_book'>Submit</button>\n".
    "</div>\n".
